...
<nav class="navbar navbar-toggleable-md fixed-top navbar-transparent" color-on-scroll="500">
	<div class="container">
		<div class="navbar-translate">
			...
			<a class="navbar-brand">Illan Christoffel <br> Thomas Fayet</a>
		</div>
		<div class="collapse navbar-collapse" id="navbarToggler">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item">
					<a class="nav-link" rel="tooltip" title="Voir notre projet sur github" data-placement="bottom"
					   href="https://www.github.com/ThomasFayet/AccesJury" target="_blank">
						<i class="fa fa-github"></i>
						<p class="hidden-lg-up"></p>
					</a>
				</li>
				<li class="nav-item">
					<a href="/projet_cvven/cvven_documentation.pdf" class="btn btn-danger btn-round">Documentation projet PHP</a>
				</li>
				<li class="nav-item">
					<a href="/projet_cvven/index.php/Reservation_controller/testconnexion" class="btn btn-danger btn-round">Se connecter</a>
				</li>
				<li class="nav-item">
					<a href="/projet_cvven/index.php/Reservation_controller/create" class="btn btn-danger btn-round">S'inscrire</a>
				</li>
				<li class="nav-item">
					<a href="/project_cvven/CVVEN-JAVA-Fayet-Thomas.rar" class="btn btn-danger btn-round">Gestion des évenements</a>
				</li>
			</ul>
		</div>
	</div>
